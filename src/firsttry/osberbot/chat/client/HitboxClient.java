...
import firsttry.osberbot.chat.message.HitboxMessage;
import firsttry.osberbot.chat.message.Message;
import firsttry.osberbot.chat.message.handler.HitboxMessageHandler;
import firsttry.osberbot.tools.HTTP;
import firsttry.osberbot.tools.JSON;
